...
<head>
    ...
    <title>Ordem | <?php echo $titulo ?></title>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="info d-flex align-items-center">
                            <div class="content">
                                <div class="logo">
                                    <h1>Sistema de Ordem de Serviço - Vitor Hugo</h1>
                                </div>
                        ...
                        <div class="form d-flex align-items-center">
                            <div class="content">
                                ...
                                <div class="form-group">
                                    ...
                                    <label for="login-username" class="label-material">Email de acesso</label>
                                </div>
                                <div class="form-group">
        ...
        $(document).ready(function() {
            ...
            $("#form").on('submit', function(e) {
                ...
                $.ajax({
                    ...
                    url: '<?php echo site_url('login/criar'); ?>', //redireciono para o método atualizar
